                ...
                <c:forEach var="user" items="${allUsers}" varStatus="number">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button onclick="document.location='/admin/listUsers/delete?id=${user.id}'">Delete
                            </button>
                            <button onclick="document.location='/admin/listUsers/change-admin-role?id=${user.id}'">
                                Ch. ADMIN role
                            </button>
                        </td>
                    </tr>
